...
public class RSA{
    ...
    public static BigInteger decrypt(BigInteger encryptedMessage, EncryptionKey secKey){
     ...
     /**
     * Static methods used to encode Strings into BigIntegers for the RSA algorithm
     * messageToBigInteger is used to parse a message into a BigInteger for en/decryption
     * valueToBigInteger is to parse the BigIntegers that were stored as Strings for purposes
     * of the database
     *
    ...
    /**
     * Static method used to encode files into BigIntegers for the RSA algorithm
     *
    ...
    /**
     * Static methods used to decode BigIntegers into text
     * messageToString will allow a decrypted message to be displayed/stored as text
     * valueToString will obtain the numerical value of the BigInteger and turn it
     * into a String
     *
    ...
    public static String valueToString(BigInteger BIMessage){
