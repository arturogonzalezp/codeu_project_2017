...
public final class NetworkCode {
  ...
  public static final int
      ...
      SEARCH_USER_IN_DATABASE_REQUEST = 31,
      SEARCH_USER_IN_DATABASE_RESPONSE = 32,
      NEW_FILE_MESSAGE_REQUEST = 33,
      NEW_FILE_MESSAGE_RESPONSE = 34,
      DOWNLOAD_FILE_REQUEST = 35,
      DOWNLOAD_FILE_RESPONSE = 36;
}
